...
@push('admin-css')
    <title>Admin | Free Quote Form Information</title>
    <!-- dataTables css -->
...
@section('admin-content')
    <section class="section">
        <div class="section-header">
            <h1>Free Quote Form Information</h1>
        </div>

        <div class="card card-primary">
            <div class="card-header">
                <h4>All Free Quote Form Information</h4>
                {{-- <div class="card-header-action">
                    <a href="{{ route('admin.free-quote-form-information.create') }}" class="btn btn-primary">Create new</a>
                </div> --}}
            </div>
            <div class="card-body">
                {{ $dataTable->table() }}
