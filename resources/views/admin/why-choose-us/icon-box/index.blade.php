...
@push('admin-css')
    <title>Admin | Why Choose Us Icon Box</title>
    <!-- dataTables css -->
...
@section('admin-content')
    <section class="section">
        <div class="section-header">
            <h1>Why Choose Us Icon Box</h1>
        </div>

        <div class="card card-primary">
            <div class="card-header">
                <h4>All Why Choose Us Icon Box</h4>
                <div class="card-header-action">
                    <a href="{{ route('admin.why-choose-us-icon-box.create') }}" class="btn btn-primary">Create new</a>
                </div>
            </div>
            <div class="card-body">
                {{ $dataTable->table() }}
