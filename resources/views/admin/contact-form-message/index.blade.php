...
@push('admin-css')
    <title>Admin | Contact Form Message</title>
    <!-- dataTables css -->
    ...
    <section class="section">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h4>All Contact Form Messages</h4>
                {{-- <div class="card-header-action">
                    <a href="{{ route('admin.contact-form-message.create') }}" class="btn btn-primary">Create new</a>
                </div> --}}
            </div>
            <div class="card-body">
                {{ $dataTable->table() }}
